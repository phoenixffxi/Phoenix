...
local mobNames =
{
    ...
    ['Dynamis-Beaucedine'] =
    {
        ...
        { 'BeZhe_Keeprazer',         mobType.NORMAL, 2 },
        ...
        { 'Deathcaller_Bidfbid',     mobType.NORMAL, 2 },
        { 'DeBho_Pyrohand',          mobType.NORMAL, 2 },
        { 'Drakefeast_Wubmfub',      mobType.NORMAL, 2 },
        { 'Draklix_Scalecrust',      mobType.NORMAL, 2 },
        ...
        { 'GoTyo_Magenapper',        mobType.NORMAL, 2 },
        ...
        { 'Maa_Zaua_the_Wyrmkeeper', mobType.NORMAL, 2 },
        { 'Mildaunegeux',            mobType.BOSS, 2 },
        { 'MiRhe_Whisperblade',      mobType.NORMAL, 2 },
        { 'Mithraslaver_Debhabob',   mobType.NORMAL, 2 },
        { 'Moltenox_Stubthumbs',     mobType.NORMAL, 2 },
        { 'Morblox_Chubbychin',      mobType.NORMAL, 2 },
        ...
        { 'Puu_Timu_the_Phantasmal', mobType.NORMAL, 2 },
        { 'Quiebitiel',              mobType.NORMAL, 2 },
        { 'Routsix_Rubbertendon',    mobType.NORMAL, 2 },
        ...
        { 'SoGho_Adderhandler',      mobType.NORMAL, 2 },
        { 'Soo_Jopo_the_Fiendking',  mobType.NORMAL, 2 },
    ...
    ['Dynamis-Xarcabard'] =
    {
        ...
        { 'Count_Raum',            mobType.NORMAL, 2 },
        { 'Count_Vine',            mobType.NORMAL, 2 },
        { 'Count_Zaebos',          mobType.NORMAL, 2 },
        { 'Duke_Berith',           mobType.NORMAL, 2 },
        { 'Duke_Gomory',           mobType.NORMAL, 2 },
        { 'Duke_Scox',             mobType.NORMAL, 2 },
        ...
        { 'King_Zagan',            mobType.NORMAL, 2 },
        { 'Marquis_Andras',        mobType.NORMAL, 2 },
        { 'Andrass_Vouivre',       mobType.NORMAL, 2 },
        { 'Marquis_Cimeries',      mobType.NORMAL, 2 },
        { 'Marquis_Decarabia',     mobType.NORMAL, 2 },
        { 'Marquis_Gamygyn',       mobType.NORMAL, 2 },
        { 'Marquis_Nebiros',       mobType.NORMAL, 2 },
        { 'Marquis_Orias',         mobType.NORMAL, 2 },
        { 'Marquis_Sabnak',        mobType.NORMAL, 2 },
        { 'Nebiross_Avatar',       mobType.NORMAL, 2 },
        { 'Prince_Seere',          mobType.NORMAL, 2 },
