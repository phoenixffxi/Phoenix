...
local mobNames =
{
    ...
    ['Dynamis-Qufim'] =
    {
        { 'Antaeus',                  mobType.BOSS      },
        { 'Scolopendra',              mobType.BOSS      },
        { 'Suttung',                  mobType.BOSS      },
        { 'Stringes',                 mobType.BOSS      },
        { 'Warchief_Tombstone',       mobType.STATUE    },
        { 'Manifest_Icon',            mobType.STATUE    },
        { 'Adamantking_Effigy',       mobType.STATUE    },
        { 'Goblin_Replica',           mobType.STATUE    },
        ...
        { 'Vanguard_Ambusher',        mobType.NORMAL    },
        { 'Vanguard_Alchemist',       mobType.NORMAL    },
        { 'Fire_Elemental',           mobType.NORMAL    },
        { 'Ice_Elemental',            mobType.NORMAL    },
        { 'Air_Elemental',            mobType.NORMAL    },
        { 'Earth_Elemental',          mobType.NORMAL    },
        { 'Thunder_Elemental',        mobType.NORMAL    },
        { 'Water_Elemental',          mobType.NORMAL    },
        { 'Light_Elemental',          mobType.NORMAL    },
        { 'Dark_Elemental',           mobType.NORMAL    },
        { 'Nightmare_Snoll',          mobType.NIGHTMARE },
        { 'Nightmare_Roc',            mobType.NIGHTMARE },
        { 'Nightmare_Stirge',         mobType.NIGHTMARE },
        { 'Nightmare_Diremite',       mobType.NIGHTMARE },
        { 'Nightmare_Kraken',         mobType.NIGHTMARE },
        { 'Nightmare_Gaylas',         mobType.NIGHTMARE },
        { 'Nightmare_Raptor',         mobType.NIGHTMARE },
        { 'Nightmare_Tiger',          mobType.NIGHTMARE },
        { 'Nightmare_Weapon',         mobType.NIGHTMARE },
    },
    ['Dynamis-Tavnazia'] =
    {
