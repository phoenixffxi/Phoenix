...
local mobNames =
{
    ...
    ['Dynamis-San_dOria'] =
    {
        { 'Overlords_Tombstone',     mobType.BOSS  , 1 },
        { 'Serjeant_Tombstone',      mobType.STATUE, 1 },
        { 'Warchief_Tombstone',      mobType.STATUE, 1 },
        { 'Battlechoir_Gitchfotch',  mobType.NORMAL, 1 },
        { 'Reapertongue_Gadgquok',   mobType.NORMAL, 1 },
        { 'Soulsender_Fugbrag',      mobType.NORMAL, 1 },
        { 'Voidstreaker_Butchnotch', mobType.NORMAL, 1 },
        { 'Wyrmgnasher_Bjakdek',     mobType.NORMAL, 1 },
    ...
    ['Dynamis-Bastok'] =
    {
        { 'GuDha_Effigy',         mobType.BOSS  , 1 },
        { 'Adamantking_Effigy',   mobType.STATUE, 1 },
        { 'GiPha_Manameister',    mobType.NORMAL, 1 },
        { 'GuNhi_Noondozer',      mobType.NORMAL, 1 },
        { 'KoDho_Cannonball',     mobType.NORMAL, 1 },
        { 'ZeVho_Fallsplitter',   mobType.NORMAL, 1 },
    ...
    ['Dynamis-Windurst'] =
    {
        { 'Tzee_Xicu_Idol',          mobType.BOSS  , 1 },
        { 'Avatar_Icon',             mobType.STATUE, 1 },
        { 'Avatar_Idol',             mobType.STATUE, 1 },
        { 'Manifest_Icon',           mobType.STATUE, 1 },
        { 'Haa_Pevi_the_Stentorian', mobType.NORMAL, 1 },
        { 'Loo_Hepe_the_Eyepiercer', mobType.NORMAL, 1 },
        { 'Maa_Febi_the_Steadfast',  mobType.NORMAL, 1 },
        { 'Muu_Febi_the_Steadfast',  mobType.NORMAL, 1 },
        { 'Wuu_Qoho_the_Razorclaw',  mobType.NORMAL, 1 },
        { 'Xoo_Kaza_the_Solemn',     mobType.NORMAL, 1 },
    ...
    ['Dynamis-Jeuno'] =
    {
        { 'Goblin_Golem',           mobType.BOSS  , 1 },
        { 'Goblin_Replica',         mobType.STATUE, 1 },
        { 'Goblin_Statue',          mobType.STATUE, 1 },
        { 'Anvilix_Sootwrists',     mobType.NORMAL, 1 },
        { 'Bandrix_Rockjaw',        mobType.NORMAL, 1 },
        { 'Blazox_Boneybod',        mobType.NORMAL, 1 },
        { 'Bootrix_Jaggedelbow',    mobType.NORMAL, 1 },
        { 'Buffrix_Eargone',        mobType.NORMAL, 1 },
        { 'Cloktix_Longnail',       mobType.NORMAL, 1 },
        { 'Distilix_Stickytoes',    mobType.NORMAL, 1 },
        { 'Elixmix_Hooknose',       mobType.NORMAL, 1 },
        { 'Eremix_Snottynostril',   mobType.NORMAL, 1 },
        { 'Gabblox_Magpietongue',   mobType.NORMAL, 1 },
        { 'Hermitrix_Toothrot',     mobType.NORMAL, 1 },
        { 'Humnox_Drumbelly',       mobType.NORMAL, 1 },
        { 'Jabbrox_Grannyguise',    mobType.NORMAL, 1 },
        { 'Jabkix_Pigeonpecs',      mobType.NORMAL, 1 },
        { 'Karashix_Swollenskull',  mobType.NORMAL, 1 },
        { 'Kikklix_Longlegs',       mobType.NORMAL, 1 },
        { 'Lurklox_Dhalmelneck',    mobType.NORMAL, 1 },
        { 'Mobpix_Mucousmouth',     mobType.NORMAL, 1 },
        { 'Morgmox_Moldnoggin',     mobType.NORMAL, 1 },
        { 'Mortilox_Wartpaws',      mobType.NORMAL, 1 },
        { 'Prowlox_Barrelbelly',    mobType.NORMAL, 1 },
        { 'Rutrix_Hamgams',         mobType.NORMAL, 1 },
        { 'Scruffix_Shaggychest',   mobType.NORMAL, 1 },
        { 'Slystix_Megapeepers',    mobType.NORMAL, 1 },
        { 'Smeltix_Thickhide',      mobType.NORMAL, 1 },
        { 'Snypestix_Eaglebeak',    mobType.NORMAL, 1 },
        { 'Sparkspox_Sweatbrow',    mobType.NORMAL, 1 },
        { 'Ticktox_Beadyeyes',      mobType.NORMAL, 1 },
        { 'Trailblix_Goatmug',      mobType.NORMAL, 1 },
        { 'Tufflix_Loglimbs',       mobType.NORMAL, 1 },
        { 'Tymexox_Ninefingers',    mobType.NORMAL, 1 },
        { 'Wasabix_Callusdigit',    mobType.NORMAL, 1 },
        { 'Wyrmwix_Snakespecs',     mobType.NORMAL, 1 },
    ...
    ['Dynamis-Buburimu'] =
    {
        ...
        { 'Baa_Dava_the_Bibliophage', mobType.NORMAL   , 1 },
        { 'Doo_Peku_the_Fleetfoot',   mobType.NORMAL   , 1 },
        { 'Elvaansticker_Bxafraff',   mobType.NORMAL   , 1 },
        { 'Flamecaller_Zoeqdoq',      mobType.NORMAL   , 1 },
        { 'GiBhe_Fleshfeaster',       mobType.NORMAL   , 1 },
        { 'Gosspix_Blabberlips',      mobType.NORMAL   , 1 },
        { 'Hamfist_Gukhbuk',          mobType.NORMAL   , 1 },
        { 'Koo_Rahi_the_Levinblade',  mobType.NORMAL   , 1 },
        { 'Lyncean_Juwgneg',          mobType.NORMAL   , 1 },
        { 'QuPho_Bloodspiller',       mobType.NORMAL   , 1 },
        { 'Ree_Nata_the_Melomanic',   mobType.NORMAL   , 1 },
        { 'Shamblix_Rottenheart',     mobType.NORMAL   , 1 },
        { 'TeZha_Ironclad',           mobType.NORMAL   , 1 },
        { 'Vanguard_Alchemist',       mobType.NORMAL   , 1 },
        { 'Vanguard_Ambusher',        mobType.NORMAL   , 1 },
        { 'Vanguard_Amputator',       mobType.NORMAL   , 1 },
        { 'Vanguard_Armorer',         mobType.NORMAL   , 1 },
        ...
        { 'Vanguard_Welldigger',      mobType.NORMAL   , 1 },
        { 'Vanguards_Wyvern',         mobType.NORMAL   , 1 },
        { 'VaRhu_Bodysnatcher',       mobType.NORMAL   , 1 },
    ...
    ['Dynamis-Tavnazia'] =
    {
        ...
        { 'Kindreds_Avatar',     mobType.NORMAL   , 1 },
        { 'Kindreds_Wyvern',     mobType.NORMAL   , 1 },
        { 'Nightmare_Antlion',   mobType.NIGHTMARE, 1 },
        { 'Nightmare_Bugard',    mobType.NIGHTMARE, 1 },
        { 'Nightmare_Cluster',   mobType.NIGHTMARE, 1 },
        { 'Nightmare_Hornet',    mobType.NIGHTMARE, 1 },
        { 'Nightmare_Leech',     mobType.NIGHTMARE, 1 },
        { 'Nightmare_Makara',    mobType.NIGHTMARE, 1 },
        { 'Nightmare_Taurus',    mobType.NIGHTMARE, 1 },
        { 'Nightmare_Worm',      mobType.NIGHTMARE, 1 },
    }
}
