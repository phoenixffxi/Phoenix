...
-- xi.dynamis.mobList[zoneID][11 ].pos = {   7.0503, 0.0000, -100.773, 192 } -- W1 W of Choc
...
-- xi.dynamis.mobList[zoneID][15 ].pos = {  16.3665, -3.000, -54.6565, 175 } -- W1 AHtop EE
-- xi.dynamis.mobList[zoneID][16 ].pos = {   8.4347, -3.000, -56.4465, 183 } -- W1 AHtop E
-- xi.dynamis.mobList[zoneID][17 ].pos = {  -0.0019, -3.000, -57.3668, 191 } -- W1 AHtop C
-- xi.dynamis.mobList[zoneID][18 ].pos = {  -8.4375, -3.000, -56.5214, 199 } -- W1 AHtop W
-- xi.dynamis.mobList[zoneID][19 ].pos = { -16.4125, -3.000, -54.3911, 207 } -- W1 AHtop WW
...
-- xi.dynamis.mobList[zoneID][22 ].pos = { -10.4154, -1.000, -106.080, 192 } -- W1 S.Gate C
-- xi.dynamis.mobList[zoneID][23 ].pos = { -24.4167, -1.000, -106.316, 192 } -- W1 S.Gate W
-- xi.dynamis.mobList[zoneID][24 ].pos = {  -5.6342, -1.000, -115.618, 192 } -- W1 S.Gate SE
-- xi.dynamis.mobList[zoneID][25 ].pos = { -16.2038, -1.000, -122.385, 192 } -- W1 S.Gate S
-- xi.dynamis.mobList[zoneID][26 ].pos = { -23.9244, -1.000, -121.605, 227 } -- W1 spawned by 330
-- xi.dynamis.mobList[zoneID][27 ].pos = { -26.3670, -1.000, -121.436, 192 } -- W1 S.Gate SW
...
-- xi.dynamis.mobList[zoneID][40 ].pos = { -44.9282, -3.493,  15.1018, 93  } -- W1 W of Boytz (N)
...
-- xi.dynamis.mobList[zoneID][55 ].pos = {   73.8867, 7.0029, -34.813, 185 } -- W1 Gal.Dist. S
-- xi.dynamis.mobList[zoneID][56 ].pos = {   83.5793, 7.0000, -32.435, 145 } -- W1 Gal.Dist. E
-- xi.dynamis.mobList[zoneID][57 ].pos = {   63.8661, 7.0000, -32.733, 215 } -- W1 Gal.Dist. W
...
-- xi.dynamis.mobList[zoneID][66 ].pos = { -103.6146, 10.0026,  56.202, 60  } -- W1 Markets C
-- xi.dynamis.mobList[zoneID][67 ].pos = { -111.2602, 12.0000,  65.935, 64  } -- W1 Markets W
-- xi.dynamis.mobList[zoneID][68 ].pos = {  -96.7740, 12.0000,  66.224, 64  } -- W1 Markets E
-- xi.dynamis.mobList[zoneID][69 ].pos = { -104.0242, 12.0000,  72.817, 64  } -- W1 Markets N
-- xi.dynamis.mobList[zoneID][70 ].pos = { -108.1392, -0.3415, -37.232, 189 } -- W1 Depot Ramp Base
-- xi.dynamis.mobList[zoneID][71 ].pos = {  -99.4389, -8.0000, -59.807, 127 } -- W1 Depot Ramp Top
-- xi.dynamis.mobList[zoneID][72 ].pos = {  -52.6932, -8.0000, -54.563, 106 } -- W1 Depot Balc N
-- xi.dynamis.mobList[zoneID][73 ].pos = {  -52.3919, -8.0000, -66.127, 147 } -- W1 Depot Balc C
-- xi.dynamis.mobList[zoneID][74 ].pos = {  -58.0759, -8.0000, -79.551, 194 } -- W1 Depot Balc S
-- xi.dynamis.mobList[zoneID][75 ].pos = { -128.0898, -0.5724,  -0.971, 64  } -- W1 Zer N.Ramp (NW)
-- xi.dynamis.mobList[zoneID][76 ].pos = { -133.1783, -0.5393,   4.024, 64  } -- W1 Zer N.Ramp (SW)
-- xi.dynamis.mobList[zoneID][77 ].pos = { -133.5637,  0.0000, -31.000, 96  } -- W1 Zer S.Clearing (NW)
-- xi.dynamis.mobList[zoneID][78 ].pos = { -122.6414,  0.0000, -43.491, 192 } -- W1 Zer S.Clearing (N)
-- xi.dynamis.mobList[zoneID][79 ].pos = { -117.1745,  0.0000, -43.491, 192 } -- W1 Zer S.Clearing (NE)
-- xi.dynamis.mobList[zoneID][80 ].pos = { -123.7850, -3.4933, -74.132, 189 } -- W1 Zer S.Clearing (S)
-- xi.dynamis.mobList[zoneID][81 ].pos = { -122.9294,  0.0000, -78.902, 165 } -- W1 Zer S.Clearing (SE)
-- xi.dynamis.mobList[zoneID][82 ].pos = { -138.1234, -11.924, 29.2820, 28  } -- W1 Zer N.Ramp (top)
-- xi.dynamis.mobList[zoneID][83 ].pos = { -147.1535,  0.000,  4.2789, 60  } -- W1 Zer W.Clearing (NE)
-- xi.dynamis.mobList[zoneID][84 ].pos = { -155.1991,  0.000,  2.2134, 28  } -- W1 Zer W.Clearing (N)
-- xi.dynamis.mobList[zoneID][85 ].pos = { -164.7690, -3.493, -2.0815, 2   } -- W1 Zer W.Clearing (NW)
-- xi.dynamis.mobList[zoneID][86 ].pos = { -161.1492,  0.000, -11.384, 249 } -- W1 Zer W.Clearing (W)
-- xi.dynamis.mobList[zoneID][87 ].pos = { -152.0940,  0.000, -20.001, 245 } -- W1 Zer W.Clearing (S)
-- xi.dynamis.mobList[zoneID][88 ].pos = { -153.7795,  0.000, -40.965, 191 } -- W1 Zer W.Ramp Base
-- xi.dynamis.mobList[zoneID][89 ].pos = { -160.1865,  0.000, -40.819, 232 } -- W1 spawned by 13
-- xi.dynamis.mobList[zoneID][90 ].pos = { -175.8118, -7.779, -21.017, 223 } -- W1 Zer W.Ramp (S)
-- xi.dynamis.mobList[zoneID][91 ].pos = { -178.4068, -8.136, -17.950, 254 } -- W1 Zer W.Ramp (W)
-- xi.dynamis.mobList[zoneID][92 ].pos = { -177.2654, -8.314, -13.560, 17  } -- W1 spawned by 1
-- xi.dynamis.mobList[zoneID][93 ].pos = { -173.8426, -7.893, -10.849, 21  } -- W1 Zer W.Ramp (N)
...
-- xi.dynamis.mobList[zoneID][100].pos = {    8.8837, 0.0000, -16.332, 192 } -- W1 O.St. CW W Enc.#2
...
-- xi.dynamis.mobList[zoneID][106].pos = {   50.8795, -0.002, -13.248, 232 } -- W1 O.St. CW E Enc.#2
-- xi.dynamis.mobList[zoneID][107].pos = {   61.7784, 0.0000, -20.673, 187 } -- W1 O.St. CW E Enc.#3
...
-- xi.dynamis.mobList[zoneID][110].pos = { -16.1024, -1.000, -124.914, 192 } -- W2 Final Boss South Gate
-- xi.dynamis.mobList[zoneID][111].pos = { -31.7986, -1.000, -122.374, 218 } -- W2 W of Final Boss
-- xi.dynamis.mobList[zoneID][112].pos = { -20.0432, -3.000, -58.9616, 56  } -- W3 AH WW
-- xi.dynamis.mobList[zoneID][113].pos = { -12.3780, -3.000, -61.4330, 89  } -- W3 AH W
-- xi.dynamis.mobList[zoneID][114].pos = {   0.1313, -3.000, -62.5700, 66  } -- W3 AH C
-- xi.dynamis.mobList[zoneID][115].pos = {  10.7283, -3.000, -61.6430, 30  } -- W3 AH E
-- xi.dynamis.mobList[zoneID][116].pos = {  19.1724, -3.000, -59.4239, 67  } -- W3 AH EE
-- xi.dynamis.mobList[zoneID][117].pos = {  18.1155, 0.0000, -99.2747, 144 } -- W3 W of Choco (N)
-- xi.dynamis.mobList[zoneID][118].pos = {  16.5028, 0.0000, -110.398, 198 } -- W3 W of Choco (C)
-- xi.dynamis.mobList[zoneID][119].pos = {  16.5175, 0.0000, -121.544, 190 } -- W3 W of Choco (S)
-- xi.dynamis.mobList[zoneID][120].pos = {   9.4977, 0.0000, -121.592, 201 } -- W3 far W of Choco
...
-- xi.dynamis.mobList[zoneID][17539291].timeExtension = 30 -- Gu'Nhi Noondozer
-- xi.dynamis.mobList[zoneID][17539090}	Vanguard Constable].timeExtension = 10 -- Vanguard Vindicator
-- xi.dynamis.mobList[zoneID][17539091}	Vanguard Vindicator].timeExtension = 10 -- Vanguard Constable
-- xi.dynamis.mobList[zoneID][17539092}	Vanguard Mason].timeExtension = 10 -- Vanguard Militant
