...
zones[xi.zone.DEN_OF_RANCOR] =
{
    text =
    {
        ...
        LANTERN_OFFSET                = 7230,  -- The grating will not budge.
        LANTERN_ALREADY_LIT           = 7237,  -- The lantern is already lit.
        RUSTY_OLD_LANTERN             = 7244,  -- Rusty old lanterns hang from this altar.
        ONE_OF_THE_LANTERNS           = 7245,  -- One of the lanterns is lit.
        TANSFORMED_INTO_A_MONSTER     = 7249,  -- The flames of rancor have transformed into a monster!
        FISHING_MESSAGE_OFFSET        = 7258,  -- You can't fish here.
        CHEST_UNLOCKED                = 7367,  -- You unlock the chest!
        FIVE_DRIED_EYEBALLS           = 7375,  -- Five dried eyeballs are stuck to the surface of the rock...
        ...
        HOMEPOINT_SET                 = 10560, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 10618, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
