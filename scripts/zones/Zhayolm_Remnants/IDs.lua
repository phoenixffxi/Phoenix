...
zones[xi.zone.ZHAYOLM_REMNANTS] =
{
    text =
    {
        ...
        TEMP_ITEM                     = 7064, -- Obtained temporary item: <item>.
        CELL_OFFSET                   = 7230, -- Main Weapon/Sub-Weapon restriction removed.
        HAVE_TEMP_ITEM                = 7252, -- You already have that temporary item.
        ...
        NOT_RESPONDING                = 7446, -- The device doesn't respond...
        DOOR_IS_SEALED_MYSTERIOUS     = 7451, -- The door is sealed by some mysterious force...
        SOCKET_TRIGGER                = 7452, -- You hear a ragged sighing from beneath the floor...
        SLOT_TRIGGER                  = 7453, -- You hear a scuttering sound from beneath the floor...
    },
    mob =
    {
