...
zones[xi.zone.SAUROMUGUE_CHAMPAIGN] =
{
    text =
    {
        ...
        MANY_TIGER_BONES              = 7252,  -- There are many tiger bones here...
        OLD_SABERTOOTH_DIALOG_I       = 7258,  -- You hear the distant roar of a tiger. It sounds as if the beast is approaching slowly...
        OLD_SABERTOOTH_DIALOG_II      = 7259,  -- The sound of the tiger's footsteps is growing louder.
        ...
        THF_AF_MOB                    = 7438,  -- Something has come down from the tower!
        THF_AF_WALL_OFFSET            = 7457,  -- It is impossible to climb this wall with your bare hands.
        ...
        TIME_ELAPSED                  = 7672,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        REGIME_REGISTERED             = 9829,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 11002, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11003, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11004, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11005, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11007, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11008, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11009, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11010, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 12510, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12512, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12519, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
