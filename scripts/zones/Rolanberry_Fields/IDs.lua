...
zones[xi.zone.ROLANBERRY_FIELDS] =
{
    text =
    {
        ...
        NOT_ENOUGH_GIL                = 6420,  -- You do not have enough gil.
        ...
        SIGN                          = 7423,  -- North: Grand Duchy of Jeuno, Sauromugue Champaign South: Pashhow Marshlands
        TIME_ELAPSED                  = 7480,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        ...
        AWAIT_YOUR_CHALLENGE          = 12190, -- We await your challenge, traveler.
        LACK_LEGION_POINTS            = 12227, -- It would seem that you lack the necessary amount of Legion points.
        LEARNS_SPELL                  = 12275, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12277, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12284, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
