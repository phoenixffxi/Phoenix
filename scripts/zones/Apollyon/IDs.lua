...
zones[xi.zone.APOLLYON] =
{
    text =
    {
        ...
        THE_PARTY_WILL_BE_REMOVED     = 7365, -- All party members in Limbus have fallen in battle. Exiting in <number> [minute/minutes].
    ...
    mob =
    {
        ...
        SW_FIR_BHOLG_OFFSET           = GetFirstID('Fir_Bholg_THF'),
        SW_ARMOURY_CRATE_MIMIC_OFFSET = GetFirstID('Armoury_Crate_Mimic'),
