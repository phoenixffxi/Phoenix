...
zones[xi.zone.CLOISTER_OF_TIDES] =
{
    text =
    {
        ...
        LEVIATHAN_UNLOCKED               = 7590, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7678, -- Entering the battlefield for [Trial by Water/Trial-Size Trial by Water/Waking the Beast/Sugar-coated Directive/★Trial by Water]!
        ATTACH_SEAL                      = 7737, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7738, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
