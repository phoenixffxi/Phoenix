...
zones[xi.zone.RIVERNE_SITE_B01] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7607, -- Entering the battlefield for [Storms of Fate/The Wyrmking Descends]!
        ...
        GROUND_GIVING_HEAT            = 7619, -- The ground here is giving off heat.
        BAHAMUT_TAUNT                 = 7687, -- Children of Vana'diel, what do you think to accomplish by fighting for your lives? You know your efforts are futile, yet still you resist...
        HOMEPOINT_SET                 = 7723, -- Home point set!
