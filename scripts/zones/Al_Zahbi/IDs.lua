...
zones[xi.zone.AL_ZAHBI] =
{
    text =
    {
        ...
        MOG_LOCKER_OFFSET             = 7407, -- Your Mog Locker lease is valid until <timestamp>, kupo.
        ...
        CHAYAYA_SHOP_DIALOG           = 7655, -- Chayaya's Projectiles! Get your darts and more at Chayaya's Projectiles! Just don't touch the stuff in the high drawers, okay?
        NEED_CANDESCENCE_BACK         = 7708, -- ...Hm? You! Yes, you! What do you think you're staring at, anyway? Go get the Astral Candescence back, and now!
        ITEM_DELIVERY_DIALOG          = 7859, -- No need to wrap your goods. Just hand them over and they're as good as delivered! (I've got to be nice as long as the manager's got his eye on me...)
        DEHBI_MOSHAL_SHOP_DIALOG      = 7863, -- Welcome to the Carpenters' Guild!
