...
zones[xi.zone.CASTLE_ZVAHL_KEEP] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA             = 7254, -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7260, -- The Goblin slipped away when you were not looking...
        HOMEPOINT_SET                 = 7303, -- Home point set!
    },
    mob =
    {
