...
zones[xi.zone.ZERUHN_MINES] =
{
    text =
    {
        ...
        MAKARIM_DIALOG_I              = 7338,  -- Be careful on your way out. Remember, you should give my report to Naji, one of the Mythril Musketeers on post at the President's Office.
        ZELMAN_CANT_RUN_AROUND        = 7363,  -- I can't run around doing everything she tells me to--I have my dignity to uphold!
        MINING_IS_POSSIBLE_HERE       = 7370,  -- Mining is possible here if you have <item>.
        PLAYER_OBTAINS_ITEM           = 7427,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7428,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7429,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7430,  -- You already possess that temporary item.
        NO_COMBINATION                = 7435,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9513,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 10561, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
    },
