...
zones[xi.zone.BEAUCEDINE_GLACIER_S] =
{
    text =
    {
        ...
        NONDESCRIPT_MASS              = 7774, -- A nondescript mass squirms hypnotically beneath the rock.
        REMAINS_OF_COOKFIRE           = 7798, -- You see the charred remains of a cookfire.
        UNWANTED_ATTENTION            = 8599, -- Your presence has drawn unwanted attention!
        UNUSUAL_PRESENCE              = 8601, -- You sense an unusual presence in the area...
        NO_RESPONSE                   = 8603, -- There is no response...
        VOIDWALKER_DESPAWN            = 8626, -- The monster fades before your eyes, a look of disappointment on its face.
        GREETINGS_TRAVELER            = 8630, -- Greetings, fair traveler. My people would entreat thy assistance, and offer rich reward in return. Thou shouldst speak with my sister Callisto, who abides in Grauberg's Witchfire Glen.
        ...
        GATHERED_DAWNDROPS_LIGHT      = 8705, -- The gathered dawndrops unleash a brilliant light, melding together to form <keyitem>!
        RETRACED_ALL_JUNCTIONS        = 8706, -- You have retraced all junctions of eventualities. Hasten back to where Cait Sith and Lilisette await.
        COMMON_SENSE_SURVIVAL         = 8710, -- It appears that you have arrived at a new survival guide provided by the Servicemen's Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
