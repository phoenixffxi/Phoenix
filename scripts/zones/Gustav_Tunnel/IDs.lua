...
zones[xi.zone.GUSTAV_TUNNEL] =
{
    text =
    {
        ...
        BAD_FEELING_ABOUT_PLACE       = 7331,  -- You have a bad feeling about this place.
        SENSE_OMINOUS_PRESENCE        = 7333,  -- You sense an ominous presence...
        UNITY_WANTED_BATTLE_INTERACT  = 7454,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9601,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10653, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10654, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10655, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10656, -- You already possess that temporary item.
        NO_COMBINATION                = 10661, -- You were unable to enter a combination.
