...
zones[xi.zone.EMPYREAL_PARADOX] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7607, -- Entering the battlefield for [Dawn/Apocalypse Nigh/Both Paths Taken/★Dawn/The Winds of Time/Sealed Fate]!
        PRISHE_TEXT                   = 7709, -- You're about to learn how strong the will to live makes us!
        SELHTEUS_TEXT                 = 7722, -- The...Emptiness... Is this...how it was meant...to be...?
        PROMATHIA_TEXT                = 7725, -- Give thyself to the apathy within...
        AIR_WARPED_AND_DISTORTED      = 7823, -- The air before you appears warped and distorted...
    },
    mob =
    {
