...
zones[xi.zone.THRONE_ROOM] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7252, -- The door is sealed shut with an evil curse.
        UNABLE_TO_PROTECT             = 7291, -- You were unable to protect Captain Volker. Now leaving the battlefield.
        ...
        MEMBERS_OF_YOUR_PARTY         = 7541, -- Currently, <number> members of your party (including yourself) have clearance to enter the battlefield.
        MEMBERS_OF_YOUR_ALLIANCE      = 7542, -- Currently, <number> members of your alliance (including yourself) have clearance to enter the battlefield.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7607, -- Entering the battlefield for [The Shadow Lord Battle/Where Two Paths Converge/Kindred Spirits/Survival of the Wisest/Smash! A Malevolent Menace/★Kindred Spirits/★The Shadow Lord Battle/True Love/A Fond Farewell/Kipdrix the Faithful]!
        NO_HIDE_AWAY                  = 7722, -- I have not been hiding away from my troubles!
        FEEL_MY_PAIN                  = 7723, -- Feel my twenty years of pain!
        YOUR_ANSWER                   = 7724, -- Is that your answer!?
        RETURN_TO_THE_DARKNESS        = 7725, -- Return with your soul to the darkness you came from!
        CANT_UNDERSTAND               = 7726, -- You--a man who has never lived bound by the chains of his country--how can you understand my pain!?
        BLADE_ANSWER                  = 7727, -- Let my blade be the answer!
    },
    mob =
    {
