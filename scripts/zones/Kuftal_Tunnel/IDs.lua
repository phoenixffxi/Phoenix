...
zones[xi.zone.KUFTAL_TUNNEL] =
{
    text =
    {
        ...
        DO_NOT_SEE_ANYTHING           = 7354,  -- You do not see anything out of the ordinary.
        FELL                          = 7357,  -- The piece of wood fell off the cliff!
        EVIL                          = 7358,  -- You sense an evil presence...
        FISHBONES                     = 7372,  -- Fish bones lie scattered about the area...
