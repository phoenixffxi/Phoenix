...
zones[xi.zone.PHOMIUNA_AQUEDUCTS] =
{
    text =
    {
        ...
        NOTHING_OUT_HERE              = 6407, -- There is nothing out of the ordinary here.
        CARRIED_OVER_POINTS           = 7004, -- You have carried over <number> login point[/s].
        LOGIN_CAMPAIGN_UNDERWAY       = 7005, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        LOGIN_NUMBER                  = 7006, -- In celebration of your most recent login (login no. <number>), we have provided you with <number> points! You currently have a total of <number> points.
        MEMBERS_LEVELS_ARE_RESTRICTED = 7026, -- Your party is unable to participate because certain members' levels are restricted.
        CONQUEST_BASE                 = 7071, -- Tallying conquest results...
        CANNOT_REACH_LADDER           = 7232, -- You cannot reach the ladder from here.
        DOOR_SEALED_SHUT              = 7233, -- The door above you is sealed shut.
        DOOR_FIRMLY_SHUT              = 7234, -- The door is firmly shut.
        DOOR_LOCKED                   = 7235, -- The door is locked. You might be able to open it with %.
        ITEM_BREAKS                   = 7237, -- The <item> breaks!
        LAMP_OFFSET                   = 7241, -- A symbol for fire is engraved on the base of the lamp...
        FISHING_MESSAGE_OFFSET        = 7254, -- You can't fish here.
        COMMON_SENSE_SURVIVAL         = 7431, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        EBA               = GetFirstID('Eba'),
