...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        GEOMAGNETRON_ATTUNED          = 7184,  -- Your <keyitem> has been attuned to a geomagnetic fount in the corresponding locale.
        MEMBERS_LEVELS_ARE_RESTRICTED = 7195,  -- Your party is unable to participate because certain members' levels are restricted.
        NOT_BROKEN_ORB                = 7256,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE           = 7257,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED            = 7284,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT          = 7285,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
