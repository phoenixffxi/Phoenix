...
zones[xi.zone.CASTLE_ZVAHL_BAILEYS] =
{
    text =
    {
        ...
        MOBLIN_EARPLUG_ON_THE_GROUND  = 7571, -- You see a Moblin earplug lying on the ground. Could Zeelozok have met his end here...?
        MARQUIS_ATTACKS               = 7572, -- Marquis Andrealphus and his minions attack!
        YOU_FIND_NOTHING              = 7573, -- You find nothing.
        BEGONE_FROM_THESE_HALLS       = 7574, -- Insolent adventurer! Begone from these halls!
        COMMON_SENSE_SURVIVAL         = 7620, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
