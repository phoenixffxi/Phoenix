...
zones[xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        CELL_OFFSET                   = 7230, -- Main Weapon/Sub-Weapon restriction removed.
        SALVAGE_START                 = 7253, -- You feel an incredible pressure bearing down on you. This area appears to be blanketed in some sort of intense psionic field...
        TIME_TO_COMPLETE              = 7460, -- You have <number> [minute/minutes] (Earth time) to complete this mission.
        MISSION_FAILED                = 7461, -- The mission has failed. Leaving area.
        TIME_REMAINING_MINUTES        = 7465, -- Time remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7466, -- Time remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN                  = 7468, -- All party members have fallen in battle. Mission failure in <number> [minute/minutes].
        DOOR_IS_SEALED                = 7479, -- The door is sealed...
        DOOR_IS_SEALED_MYSTERIOUS     = 7482, -- The door is sealed by some mysterious force...
    },
    mob =
    {
        [1] =
