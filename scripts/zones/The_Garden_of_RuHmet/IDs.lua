...
zones[xi.zone.THE_GARDEN_OF_RUHMET] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7626, -- Entering the battlefield for [When Angels Fall/]!
        YOU_MUST_MOVE_CLOSER          = 7634, -- You must move closer.
        PORTAL_WONT_OPEN_ON_THIS_SIDE = 7636, -- The portal won't open from this side.
        NO_NEED_INVESTIGATE           = 7642, -- There is no need to investigate further.
        PORTAL_SEALED                 = 7671, -- The portal is firmly sealed by a mysterious energy.
        FORTITUDE_QM                  = 7778, -- You hear something vaguely resembling a voice emanating from the depths of your soul. Bring...mem...ries...hrah...
        UNKNOWN_PRESENCE              = 7779, -- You sense some unknown presence...
        NONE_HOSTILE                  = 7780, -- You sense some unknown presence, but it does not seem hostile.
        MENACING_CREATURES            = 7781, -- Menacing creatures appear out of nowhere!
        SHEER_ANIMOSITY               = 7782, -- <name> is enveloped in sheer animosity!
        FAITH_QM                      = 7784, -- You hear something vaguely resembling a voice emanating from the depths of your soul. Bring me...euv...recccepta...
