...
zones[xi.zone.CASTLE_OZTROJA] =
{
    text =
    {
        ...
        NOT_ENOUGH_GIL                     = 6583, -- You do not have enough gil.
        ITEMS_OBTAINED                     = 6587, -- You obtain <number> <item>!
        NOTHING_OUT_OF_ORDINARY            = 6592, -- There is nothing out of the ordinary here.
        ...
        LOGIN_CAMPAIGN_UNDERWAY            = 7190, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        ...
        MEMBERS_LEVELS_ARE_RESTRICTED      = 7211, -- Your party is unable to participate because certain members' levels are restricted.
        FISHING_MESSAGE_OFFSET             = 7275, -- You can't fish here.
        CHEST_UNLOCKED                     = 7447, -- You unlock the chest!
        FLAME_BURNING                      = 7455, -- A mysterious flame is burning.
        YOU_HOLD                           = 7456, -- You hold <item> over the flame... A peculiar scent covers the area.
        TEBHI_ACCEPTS                      = 7458, -- Tebhi happily accepts the <item> and leaves.
        YAGUDO_AVATAR_ENGAGE               = 7468, -- Kahk-ka-ka... You filthy, dim-witted heretics! You have damned yourselves by coming here.
        YAGUDO_AVATAR_DEATH                = 7469, -- Our lord, Tzee Xicu the Manifest! Even should our bodies be crushed and broken, may our souls endure into eternity...
        YAGUDO_KING_ENGAGE                 = 7470, -- You are not here as sacrifices, are you? Could you possibly be committing this affront in the face of a deity? Very well, I will personally mete out your divine punishment, kyah!
        YAGUDO_KING_DEATH                  = 7471, -- You have...bested me... However, I...am...a god... I will never die...never rot...never fade...never...
        HERETICS                           = 8016, -- Kyah! Kyah! Heretics being in our midst! Kill them!
        LETTING_YOU_GO                     = 8023, -- This time I be letting you go. Be flying home, smoothskin! Ka-kyah!
        LEARNS_SPELL                       = 8312, -- <name> learns <spell>!
        UNCANNY_SENSATION                  = 8314, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL              = 8321, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
