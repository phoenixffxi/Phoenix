...
zones[xi.zone.SEALIONS_DEN] =
{
    text =
    {
        ...
        IRON_GATE_LOCKED              = 7108, -- A solid iron gate. It is tightly locked...
        ...
        CONQUEST_BASE                 = 7444, -- Tallying conquest results...
        ENTERING_THE_BATTLEFIELD_FOR  = 7607, -- Entering the battlefield for [One to Be Feared/The Warrior's Path/★The Warrior's Path/★One to Be Feared]!
        COSMIC_ELUCIDATION            = 7903, -- You are overwhelmed by Tenzen's Cosmic Elucidation!
        TENZEN_MSG_OFFSET             = 7935, -- You will fall to my blade!
        MAKKI_CHEBUKKI_OFFSET         = 7939, -- Samurai Sky Pirate Power!
        KUKKI_CHEBUKKI_OFFSET         = 7944, -- What? Nooo!
        CHERUKIKI_OFFSET              = 7950, -- We're doomed!
    },
    mob =
    {
