...
xi.dynamis.spawnTable[zoneID] =
{
    ...
    -- MP = green HP = blue
    [16937267] = { 3, xi.dynamis.eye.RED      }, -- (001-Y) | WHM, NIN, MNK
    [16937275] = { 3, xi.dynamis.eye.RED      }, -- (002-Y) | RDM, BST, DRK
    [16937271] = { 3, xi.dynamis.eye.RED      }, -- (003-Y) | PLD, BLM, SAM
    [16937263] = { 3, xi.dynamis.eye.RED      }, -- (004-Y) | WAR, RNG, RDM
    [16937005] = { 0,                         }, -- (005-Funguar NM (Fairy Ring)) |
    [16937292] = { 3, xi.dynamis.eye.RED      }, -- (006-G(HP)) | BRD, BST, DRK
    [16937288] = { 3, xi.dynamis.eye.RED      }, -- (007-G(MP)) | PLD, BLM, SAM
    [16937284] = { 3, xi.dynamis.eye.RED      }, -- (008-G) | WHM, NIN, MNK
    [16937280] = { 3, xi.dynamis.eye.RED      }, -- (009-G) | WAR, RNG, RDM
    [16937001] = { 2,                         }, -- (010-Flytrap NMs (Dragontrap ×3)) |
    [16937237] = { 3, xi.dynamis.eye.RED      }, -- (011-O) | PLD, BLM, SAM
    [16937229] = { 3, xi.dynamis.eye.RED      }, -- (012-O) | WAR, RNG, RDM
    [16937241] = { 3, xi.dynamis.eye.RED      }, -- (013-O) | BST, BRD, DRK
    [16937233] = { 3, xi.dynamis.eye.RED      }, -- (014-O) | WHM, NIN, MNK
    [16937000] = { 0,                         }, -- (015-Treant NM (Stcemqestcint)) |
    [16937250] = { 3, xi.dynamis.eye.RED      }, -- (016-Q(HP)) | WHM, NIN, MNK
    [16937246] = { 3, xi.dynamis.eye.RED      }, -- (017-Q) | WAR, RNG, RDM
    [16937254] = { 3, xi.dynamis.eye.RED      }, -- (018-Q) | PLD, BLM
    [16937258] = { 3, xi.dynamis.eye.RED      }, -- (019-Q) | BRD, BST, DRK
    ...
    [16936982] = { 3, xi.dynamis.eye.RED      }, -- (025-G) | THF, DRG, SMN
    [16936976] = { 3, xi.dynamis.eye.RED      }, -- (026-Y) | THF, DRG, SMN
    [16936970] = { 3, xi.dynamis.eye.RED      }, -- (027-Q) | THF, DRG, SMN
    [16936964] = { 3, xi.dynamis.eye.RED      }, -- (028-O) | THF, DRG, SMN
    ...
    [16937343] = { 3, xi.dynamis.eye.RED      }, -- (033-Y) | WAR, RNG, RDM
    [16937347] = { 3, xi.dynamis.eye.RED      }, -- (034-Y) | WHM, NIN, MNK
    [16937351] = { 3, xi.dynamis.eye.RED      }, -- (035-Y) | PLD, BLM, SAM
    [16937355] = { 3, xi.dynamis.eye.RED      }, -- (036-Y) | RDM, BST, DRK
    [16937360] = { 3, xi.dynamis.eye.RED      }, -- (037-Y) | THF, DRG, SMN
    [16937366] = { 3, xi.dynamis.eye.RED      }, -- (038-G) | WAR, RNG, RDM
    [16937370] = { 3, xi.dynamis.eye.RED      }, -- (039-G) | WHM, NIN, MNK
    [16937374] = { 3, xi.dynamis.eye.RED      }, -- (040-G) | PLD, BLM, SAM
    [16937378] = { 3, xi.dynamis.eye.RED      }, -- (041-G) | BRD, BST, DRK
    [16937383] = { 3, xi.dynamis.eye.RED      }, -- (042-G) | THF, DRG, SMN
    [16937297] = { 3, xi.dynamis.eye.RED      }, -- (043-O) | WAR, RNG, RDM
    [16937301] = { 3, xi.dynamis.eye.RED      }, -- (044-O) | WHM, NIN, MNK
    [16937305] = { 3, xi.dynamis.eye.RED      }, -- (045-O) | PLD, BLM, SAM
    [16937309] = { 3, xi.dynamis.eye.RED      }, -- (046-O) | BST, BRD, DRK
    [16937314] = { 3, xi.dynamis.eye.RED      }, -- (047-O) | THF, DRG, SMN
    [16937320] = { 3, xi.dynamis.eye.RED      }, -- (048-Q) | WAR, RNG, RDM
    [16937324] = { 3, xi.dynamis.eye.RED      }, -- (049-Q) | WHM, NIN, MNK
    [16937328] = { 3, xi.dynamis.eye.RED      }, -- (050-Q) | PLD, BLM
    [16937332] = { 3, xi.dynamis.eye.RED      }, -- (051-Q) | BRD, BST, DRK
    [16937337] = { 3, xi.dynamis.eye.RED      }, -- (052-Q) | THF, DRG, SMN
...
xi.dynamis.wave[zoneID] =
{
    ...
    {
        16936982, -- (025-G) Goblin Replica
        16936976, -- (026-Y) Manifest Icon
        16936970, -- (027-Q) Adamantking Effigy
        16936964, -- (028-O) Serjeant Tombstone
