...
local familyEES =
{
    [xi.mobSpecies.AERN          ] = xi.mobSkill.EES_AERN,
    [xi.mobSpecies.ANTICA        ] = xi.mobSkill.EES_ANTICA,
    [xi.mobSpecies.FALLEN        ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.FOMOR         ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.HYDRAFOMOR    ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.SPECTRE       ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.VALKYR        ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.SHADOW        ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.GIANTS        ] = xi.mobSkill.EES_GIGAS,
    [xi.mobSpecies.GIGAS         ] = xi.mobSkill.EES_GIGAS,
    [xi.mobSpecies.JOTUNN        ] = xi.mobSkill.EES_GIGAS,
    [xi.mobSpecies.ARMORED_GOBLIN] = xi.mobSkill.EES_GOBLIN,
    [xi.mobSpecies.ARMORED_MOBLIN] = xi.mobSkill.EES_GOBLIN,
    [xi.mobSpecies.GOBLIN        ] = xi.mobSkill.EES_GOBLIN,
    [xi.mobSpecies.MOBLIN        ] = xi.mobSkill.EES_GOBLIN,
    [xi.mobSpecies.DEMON         ] = xi.mobSkill.EES_KINDRED,
    [xi.mobSpecies.RED_DEMON     ] = xi.mobSkill.EES_KINDRED,
    [xi.mobSpecies.KINDRED       ] = xi.mobSkill.EES_KINDRED,
    [xi.mobSpecies.LAMIAE        ] = xi.mobSkill.EES_LAMIA,
    [xi.mobSpecies.MEDUSA        ] = xi.mobSkill.EES_LAMIA,
    [xi.mobSpecies.MERROW        ] = xi.mobSkill.EES_MERROW,
    [xi.mobSpecies.ORC           ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.RED_ORC       ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.WARCHIEF      ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.WHITE_ORC     ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.QUADAV        ] = xi.mobSkill.EES_QUADAV,
    [xi.mobSpecies.DESTROYER     ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.GENERAL       ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.TROLL         ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.ARMORED_YAGUDO] = xi.mobSkill.EES_YAGUDO,
    [xi.mobSpecies.MANIFEST      ] = xi.mobSkill.EES_YAGUDO,
    [xi.mobSpecies.YAGUDO        ] = xi.mobSkill.EES_YAGUDO,
    [xi.mobSpecies.HUMES         ] = xi.mobSkill.EES_MAAT,
}
