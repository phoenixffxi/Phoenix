...
content.loot =
{
    ...
    [ID.npc.C4_LOOT_CRATE] =
    {
        ...
        {
            quantity = 2,
            { itemId = xi.item.PIECE_OF_ULTIMAS_CEREBRUM, weight = xi.loot.weight.NORMAL },
            { itemId = xi.item.SEGMENT_OF_ULTIMAS_CLAW,   weight = xi.loot.weight.LOW    },
            { itemId = xi.item.SEGMENT_OF_ULTIMAS_LEG,    weight = xi.loot.weight.LOW    },
            { itemId = xi.item.SEGMENT_OF_ULTIMAS_TAIL,   weight = xi.loot.weight.LOW    },
        },

        {
            { itemId = xi.item.NONE,                   weight = xi.loot.weight.EXTREMELY_HIGH },
            { itemId = xi.item.PIECE_OF_ULTIMAS_HEART, weight = xi.loot.weight.NORMAL         },
        },
    },
}
